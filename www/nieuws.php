...
<html lang="nl">
  <head>
    ...
    <title>Nieuws - Stichting Zwembad De Marne</title>
  ...
  <body>
            ...
            echo "
              <li><a onclick='menuEnable(this)'><i class='material-icons'>menu</i>Menu <i class='material-icons'>keyboard_arrow_down</i></a>
                <ul>
                  ...
                  <li><a href='#' class='huidig'><i class='material-icons'>import_contacts</i>Nieuws</a></li>
    ...
    <nav id="pc_tablet">
      <ul>
        ...
        <li><a href="#" class="huidig">Nieuws</a></li>
    ...
    <section id="middle">
      <div id="inhoud">
        <div class='sideFoto'>
          <img src='images/feest2017/20170620_190515.jpg'>
        </div>
        <div class='sideFoto'>
          <img src='images/feest2017/20170621_190253.jpg'>
        </div>
        <div class='sideFoto'>
          <img src='images/feest2017/20170621_190816.jpg'>
        </div>
        <div class='sideFoto'>
          <img src='images/feest2017/20170621_195543.jpg'>
        </div>
        <div class='sideFoto'>
          <img src='images/feest2017/20170622_190246.jpg'>
        </div>
        <div class='sideFoto'>
          <img src='images/feest2017/20170623_185625.jpg'>
        </div>
        <div class='sideFoto'>
        ...
        <div style="clear:right;">
          <?php
            include("includes/milieustraat.html");
          ?>
        </div>
      </div>
      <div id="zijkant">
