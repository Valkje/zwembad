...
<html lang="nl">
  <head>
    ...
    <title>Activiteit verwijderen - Stichting Zwembad De Marne</title>
      ...
      <div id="inhoud">
        ...
        <?php
          ...
          if (!mysql_query($query)) {
              echo "Het is niet gelukt om de activiteit te verwijderen. Klik <a onclick='history.back()'>hier</a> om terug te gaan naar de vorige pagina.";
          } else {
              echo "
                Het verwijderen van de activiteit is gelukt! U wordt binnen enkele seconden teruggestuurd naar de beheerpagina.
