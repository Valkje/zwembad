...
<html lang="nl">
  <head>
    ...
    <title>Activiteit aanpassen - Stichting Zwembad De Marne</title>
    ...
    <section id="middle">
      <div id="inhoud">
        ...
        <?php
          ...
          $query = "
            UPDATE events
            SET titel = '$titel', beschrijving = '$beschrijving', starttijd = '$starttijd',
                eindtijd = '$eindtijd', startdatum = '$startdatum', einddatum = '$einddatum'
            WHERE id = $id
          ";
          if (!mysql_query($query)) {
              echo "Het is niet gelukt om de activiteit aan te passen. Klik <a onclick='history.back()'>hier</a> om terug te gaan naar de vorige pagina.";
          } else {
              echo "
                Het aanpassen van de activiteit is gelukt! U wordt binnen enkele seconden teruggestuurd naar de beheerpagina.
