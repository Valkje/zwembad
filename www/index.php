...
<html lang="nl">
  <head>
    ...
    <title>Stichting Zwembad De Marne</title>
  ...
  <body class="index">
        ...
        if ($_SESSION['ingelogd']) {
            echo "
              <li><a onclick='menuEnable(this)'><i class='material-icons'>menu</i>Menu <i class='material-icons'>keyboard_arrow_down</i></a>
                <ul>
                  <li><a href='#' class='huidig'><i class='material-icons'>home</i>Home</a></li>
    ...
    <nav id="pc_tablet">
      <ul>
        <li><a href="#" class="huidig">Home</a></li>
    ...
    <section id="middle">
      <div id="inhoud">
        <h2>Welkom op de website van Zwembad De Marne en Omstreken!</h2>
        <p>
          Kom zwemmen in Leens! <br>
          Al jarenlang is dit de plek waar jong en oud bijeenkomt, een duik neemt; <br>
          waar de jongere zijn of haar diploma's haalt, omgaat met zijn/haar vrienden; <br>
          waar de iets minder jongere een praatje maakt, eens rustig een baantje zwemt; <br>
          waar badjuffen en -meesters altijd vriendelijk en behulpzaam zijn; <br>
          waar kortom iedereen plezier beleeft! <br>
        </p>
        <h2>Voorverkoop 2018</h2>
        <p>
          De zomer komt er weer aan! Dat betekent eveneens dat de voorverkoop
          van de abonnementen weer begint. Formulieren en meer info vind u
          <a href='openingstijden'>hier</a>.
        </p>
        <img src="images/fotos/bomOnderWater.jpg" alt="bomOnderWater">
      </div>
      <div id="zijkant">
        <h2>Activiteiten</h2>
        <ul id="events"></ul>
